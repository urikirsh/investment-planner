...
class MainWindowSummaryMixin:
    ...
    def _init_summary_screen(self) -> None:
        ...
        self.screen_summary.quit_btn.clicked.connect(self._quit_app)  # type: ignore[attr-defined]
    ...
    def _summary_next(self) -> None:
        ...
        if not self.planning_state.plan_steps:
            ...
            return
        self._show_current_wizard_step()  # type: ignore[attr-defined]
        self.stack.setCurrentWidget(self.screen_wizard)
        self._prepare_wizard_fx_rate_cache()  # type: ignore[attr-defined]
